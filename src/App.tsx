...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route path="/full" element={<MarketingPage />} />
      ...
      <Route path="/admin/contact-submissions" element={<ProtectedRoute requireAdmin><AdminContactSubmissionsPage /></ProtectedRoute>} />

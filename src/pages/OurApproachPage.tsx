        ...
        <div className="max-w-[560px] mx-auto px-6 md:px-8">
          ...
          <div className="space-y-4 mb-16">
            <p className="text-base leading-[1.65] text-foreground">
              At Tribes, publishing administration is not clerical work. It is long-term rights stewardship.
            </p>
            <p className="text-base leading-[1.65] text-muted-foreground">
              We treat music as a durable asset that requires precision, continuity, and disciplined recordkeeping over time.
            </p>
          </div>
          ...
          <section className="mb-16">
            ...
            <div className="space-y-10">
              ...
              <div>
                <h3 className="text-base font-medium text-foreground mb-2">
                  Clarity for Creators and Rights Holders
                </h3>
                <p className="text-sm leading-[1.65] text-muted-foreground">

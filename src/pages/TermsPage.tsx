...
/**
 * TERMS OF USE PAGE — Uses global ContentPageLayout standard
  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <ul className="space-y-1.5 text-[15px] text-muted-foreground leading-relaxed">
      ...
      <section>
        <h2 className="text-foreground mb-3">2. Eligibility</h2>
      ...
      <section>
        <h2 className="text-foreground mb-3">3. License to Use</h2>
        <div className="space-y-2 text-[15px] text-muted-foreground leading-relaxed">
          <p>
      ...
      <section>
        <h2 className="text-foreground mb-3">4. Portal Access</h2>
      ...
      <section>
        <h2 className="text-foreground mb-3">5. Account Security</h2>
        <div className="space-y-2 text-[15px] text-muted-foreground leading-relaxed">
          <p>You agree to:</p>
          <ul className="space-y-1 ml-4">
      ...
      <section>
        <h2 className="text-foreground mb-3">6. Licensing</h2>
        <div className="space-y-2 text-[15px] text-muted-foreground leading-relaxed">
      ...
      <section>
        <h2 className="text-foreground mb-3">7. Electronic Communications</h2>
        <p className="text-[15px] text-muted-foreground leading-relaxed">
      ...
      <section>
        <h2 className="text-foreground mb-3">8. Your Submissions</h2>
        <div className="space-y-2 text-[15px] text-muted-foreground leading-relaxed">
      ...
      <section>
        <h2 className="text-foreground mb-3">9. Privacy</h2>
        <p className="text-[15px] text-muted-foreground leading-relaxed">
      ...
      <section>
        <h2 className="text-foreground mb-3">10. Intellectual Property</h2>
        <div className="space-y-2 text-[15px] text-muted-foreground leading-relaxed">
          <p>
      ...
      <section>
        <h2 className="text-foreground mb-3">11. Disclaimers</h2>
        <div className="space-y-2 text-[15px] text-muted-foreground leading-relaxed">
      ...
      <section>
        <h2 className="text-foreground mb-3">12. Limitation of Liability</h2>
        <div className="space-y-2 text-[15px] text-muted-foreground leading-relaxed">
          <p className="uppercase text-[13px]">
      ...
      <section>
        <h2 className="text-foreground mb-3">13. Indemnification</h2>
        <p className="text-[15px] text-muted-foreground leading-relaxed">
      ...
      <section>
        <h2 className="text-foreground mb-3">14. Termination</h2>
        <div className="space-y-2 text-[15px] text-muted-foreground leading-relaxed">
      ...
      <section>
        <h2 className="text-foreground mb-3">15. Governing Law</h2>
        <p className="text-[15px] text-muted-foreground leading-relaxed">
      ...
      <section>
        <h2 className="text-foreground mb-3">16. Miscellaneous</h2>
        <div className="space-y-2 text-[15px] text-muted-foreground leading-relaxed">
      ...
      <section>
        <h2 className="text-foreground mb-3">17. Contact</h2>

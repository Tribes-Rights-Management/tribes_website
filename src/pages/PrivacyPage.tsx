          ...
          <div className="space-y-10">
            ...
            <section>
              ...
              <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
                ...
                <div>
                  <h3 className="text-sm font-medium text-foreground mb-2">Portal Users</h3>
                ...
                <div>
                  <h3 className="text-sm font-medium text-foreground mb-2">Automatic Collection</h3>
                  <p>
            ...
            <section>
              <h2 className="text-lg font-medium text-foreground mb-3">How We Use Information</h2>
            ...
            <section>
              <h2 className="text-lg font-medium text-foreground mb-3">When We Share Information</h2>
              <div className="text-sm text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-medium text-foreground mb-3">Analytics</h2>
            ...
            <section>
              <h2 className="text-lg font-medium text-foreground mb-3">California Privacy Rights</h2>
            ...
            <section>
              <h2 className="text-lg font-medium text-foreground mb-3">Do Not Track</h2>
              <p className="text-sm text-muted-foreground leading-relaxed">

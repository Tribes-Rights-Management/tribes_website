...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        "accordion-down": "accordion-down 220ms cubic-bezier(0.25, 0.1, 0.25, 1)",
        "accordion-up": "accordion-up 220ms cubic-bezier(0.25, 0.1, 0.25, 1)",
        "content-fade": "content-fade 220ms cubic-bezier(0.25, 0.1, 0.25, 1)",
        "slide-in-right": "slide-in-right 280ms cubic-bezier(0.25, 0.1, 0.25, 1)",
        "slide-out-right": "slide-out-right 280ms cubic-bezier(0.25, 0.1, 0.25, 1)",
      },
      transitionDuration: {
        'micro': '120ms',
        'standard': '220ms',
